...
public class DropDownDemo {
	...
	public static void main(String[] args) {
		...
		driver.get("https://tutorialehtml.com/en/html-tutorial-drop-down-lists-menu/");
			// to handle the dropdown list selenium uses Select class. We have to create a select object to be able to 
			//1. We need to find select tag
		...
		list.getFirstSelectedOption();
			//4.Print the selected value: option 1
